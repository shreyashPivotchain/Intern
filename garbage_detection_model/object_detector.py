...
def realtime_detection( model_file_path):# function
    threshold = 0.77#cutoff decides which probability of object to detect 50% sured object will will be detected
        ...
        while cap.isOpened():
            ...
            for i in range(int(out[0][0])):
                ...
                if score > threshold:
                    ...
                    draw.text((left, top), 'Garbage'+ str(round(score, 2)), (255, 255, 255), font=font)
